!(function (t, e) {
  ...
  r.prototype = {
    ...
    emit: function (t) {
      for (
        var e = [].slice.call(arguments, 1), i = ((this.e || (this.e = {}))[t] || []).slice(), n = 0, s = i.length;
        n < s;
        n++
      )
  ...
  function b(t, e) {
    ...
    return (
      I() || 'width' !== e
        ? I() ||
          'height' !== e ||
          (n += m(i.paddingTop) + m(i.paddingBottom) + m(i.borderTopWidth) + m(i.borderBottomWidth))
            ...
            },
            {
              ...
              value: function () {
                ...
                e && t && this.isInitialized
                  ...
                  : e
                    ? (this._styleImmediately(this._queue), this._dispatch(r.EventType.LAYOUT))
