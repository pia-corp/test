        ...
        7796: function (e, t, r) {
            ...
            function es(e) {
                ...
                !(function () {
                    if (!l) return;
                    let e = new Set(
                            V(document.querySelectorAll('style[data-n-href]')).map((e) => e.getAttribute('data-n-href'))
                        ),
            ...
            function y(e) {
                ...
                if (
                    ...
                    ('beforeInteractive' === s || 'worker' === s) &&
                        (_
                            ? ((g[s] = (g[s] || []).concat([{id: t, src: r, onLoad: n, onReady: o, onError: f, ...h}])),
                              _(g))
                            : y && y()
                              ? d.add(t || r)
                              : y && !y() && m(e)),
                    ...
                    'afterInteractive' === s &&
                        ...
                        i.default.preload(
                            r,
                            h.integrity ? {as: 'script', integrity: h.integrity, nonce: P} : {as: 'script', nonce: P}
                        );
                }
                return null;
            }
        ...
        9554: function (e, t, r) {
                ...
                let {
                    ...
                    d = (e) => {
                        ...
                        return (function e(t, r, n) {
                            ...
                            .then(
                                (e) => (
                                    (l && 'no-cache' !== e.response.headers.get('x-middleware-cache')) || delete r[f], e
                                )
                            )
                            .catch((e) => {
                                throw (
            ...
            class V {
                    ...
                    try {
                        ...
                        return (
                            ...
                            this.isPreview ||
                                ...
                                h ||
                                W(
                                    Object.assign({}, O, {isBackground: !0, persistCache: !1, inflightCache: this.sbc})
                                ).catch(() => {}),
                ...
                async prefetch(e, t, r) {
                    if ((void 0 === t && (t = e), void 0 === r && (r = {}), (0, x.isBot)(window.navigator.userAgent)))
                        return;
                ...
                getInitialProps(e, t) {
                    let {Component: r} = this.components['/_app'],
                        n = this._wrapApp(r);
                    return (
                        (t.AppTree = n), (0, d.loadGetInitialProps)(r, {AppTree: n, Component: e, router: this, ctx: t})
                    );
                }
                get route() {
